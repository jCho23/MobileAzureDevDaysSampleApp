...
All code should be formatted to our code guidelines. This will be considered in all pull requests and is a best practice to develop as a team. Please use David Siegel's cSharp styling: https://github.com/dvdsgl/csharp-in-style 
